 ...
 * 
	...
	This class is used for the generic static function which do not relay on a specific class object,
but also support blueprint call.
	
	OOP way can inherit variable which static(class c,T t) way can not achieve.
 */
UCLASS()
